...
console.log(activeTabs)
  ...
  return (
    ...
    <div className="nc-Header bg-white fixed top-0 w-full left-0 right-0 z-30 shadow-sm">
      <div className="relative px-1">
        <div className="px-4 container lg:container py-4 lg:py-5  relative flex  justify-around items-center">
          ...
          <div className="lg:hidden flex-[3] max-w-lg !mx-auto md:px-3">
            <div className="">
              <button className="relative flex items-center w-full border border-neutral-200 px-2 py-2 pr-11 rounded-full shadow-lg" onClick={()=> setOpenSearch(true)}>
                <GrSearch />
