    ...
    <div className="container relative mt-20 space-y-24 mb-24 lg:space-y-28 lg:mb-28">
      ...
      <div className='flex flex-col lg:flex-row lg:items-center'>
        <div className='flex-shrink-0 lg:w-1/2 flex flex-col items-start space-y-8 sm:space-y-10 pb-14 lg:pb-64 xl:pr-14 lg:mr-10 xl:mr-0'>
          ...
          <button className='hero-btn transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-6000' type='button'>Start your search</button>
        </div>
