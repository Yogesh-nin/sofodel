    ...
    <div className="hidden lg:block z-10 mb-12 lg:mb-0 lg:-mt-40 w-full">
        <div className="w-full max-w-6xl py-5 lg:py-0 ">
            <ul className="ml-2 sm:ml-6 md:ml-12 flex space-x-5 sm:space-x-8 lg:space-x-11 overflow-x-auto">
                <li className="flex-shrink-0 flex items-center cursor-pointer text-sm lg:text-base font-medium">
            ...
            <form action="" className="w-full px-5 py-3 relative mt-8 flex flex-col md:flex-row  rounded-3xl md:rounded-full shadow-xl dark:shadow-2xl bg-white dark:bg-neutral-800 divide-y divide-neutral-200 dark:divide-neutral-700  md:divide-y-0">
                <div className="relative flex flex-[1.5]">
                    <div className="flex flex-1 relative flex-shrink-0 items-center space-x-3 cursor-pointer focus:outline-none text-left  ">
                        ...
                        <div className="flex-grow">
                            <input type="text" className="block w-full bg-transparent border-none focus:ring-0 p-0 focus:outline-none focus:placeholder-gray-300 xl:text-lg font-semibold placeholder-gray-800 dark:placeholder-gray-200 truncate" placeholder='Location' />
                        </div>
                    </div>
                </div>
