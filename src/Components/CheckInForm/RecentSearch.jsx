...
const RecentSearch = (props) => {
  ...
  return (
    <div className="absolute left-0 z-10 w-full min-w-[300px] sm:min-w-[500px] bg-white top-full mt-3 py-3 sm:py-6 rounded-3xl shadow-xl max-h-96 overflow-y-auto" ref={refOne}>
